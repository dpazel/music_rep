...
def reshape_with_pf():
    ...
    constraints = {
        ...
        PitchRangeConstraint([all_notes[9]], PitchRange.create('C:4', 'G:4')),
...
def reshape_to_scale():
    ...
    line_str = '{<C-Major: I> iE:4 E E E E E E E E E E E E E E E E E E E E E E E hE}'
