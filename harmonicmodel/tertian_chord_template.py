...
class TertianChordTemplate(ChordTemplate):
    ...
    TERTIAN_CHORD_TYPE_MAP = {
        TertianChordType.Maj: [Interval(1, IntervalType(IntervalType.Perfect)),
                               Interval(3, IntervalType(IntervalType.Major)),
                               Interval(5, IntervalType(IntervalType.Perfect))],
        TertianChordType.MajSus2: [Interval(1, IntervalType(IntervalType.Perfect)),
                                   Interval(2, IntervalType(IntervalType.Major)),
                                   Interval(5, IntervalType(IntervalType.Perfect))],
        TertianChordType.MajSus4: [Interval(1, IntervalType(IntervalType.Perfect)),
                                   Interval(4, IntervalType(IntervalType.Perfect)),
                                   Interval(5, IntervalType(IntervalType.Perfect))],
        TertianChordType.MajSus: [Interval(1, IntervalType(IntervalType.Perfect)),
                                  Interval(4, IntervalType(IntervalType.Perfect)),
                                  Interval(5, IntervalType(IntervalType.Perfect))],
        TertianChordType.Min: [Interval(1, IntervalType(IntervalType.Perfect)),
                               Interval(3, IntervalType(IntervalType.Minor)),
                               Interval(5, IntervalType(IntervalType.Perfect))],
        TertianChordType.Dim: [Interval(1, IntervalType(IntervalType.Perfect)),
                               Interval(3, IntervalType(IntervalType.Minor)),
                               Interval(5, IntervalType(IntervalType.Diminished))],
        TertianChordType.Aug: [Interval(1, IntervalType(IntervalType.Perfect)),
                               Interval(3, IntervalType(IntervalType.Major)),
                               Interval(5, IntervalType(IntervalType.Augmented))],
        TertianChordType.Maj7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                Interval(3, IntervalType(IntervalType.Major)),
                                Interval(5, IntervalType(IntervalType.Perfect)),
                                Interval(7, IntervalType(IntervalType.Major))],
        TertianChordType.Maj7Sus2: [Interval(1, IntervalType(IntervalType.Perfect)),
                                    Interval(2, IntervalType(IntervalType.Major)),
                                    Interval(5, IntervalType(IntervalType.Perfect)),
                                    Interval(7, IntervalType(IntervalType.Major))],
        TertianChordType.Maj7Sus4: [Interval(1, IntervalType(IntervalType.Perfect)),
                                    Interval(4, IntervalType(IntervalType.Perfect)),
                                    Interval(5, IntervalType(IntervalType.Perfect)),
                                    Interval(7, IntervalType(IntervalType.Major))],
        TertianChordType.Maj7Sus: [Interval(1, IntervalType(IntervalType.Perfect)),
                                   Interval(4, IntervalType(IntervalType.Perfect)),
                                   Interval(5, IntervalType(IntervalType.Perfect)),
                                   Interval(7, IntervalType(IntervalType.Major))],
        TertianChordType.Min7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                Interval(3, IntervalType(IntervalType.Minor)),
                                Interval(5, IntervalType(IntervalType.Perfect)),
                                Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.Dom7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                Interval(3, IntervalType(IntervalType.Major)),
                                Interval(5, IntervalType(IntervalType.Perfect)),
                                Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.Dom7Sus2: [Interval(1, IntervalType(IntervalType.Perfect)),
                                    Interval(2, IntervalType(IntervalType.Major)),
                                    Interval(5, IntervalType(IntervalType.Perfect)),
                                    Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.Dom7Sus4: [Interval(1, IntervalType(IntervalType.Perfect)),
                                    Interval(4, IntervalType(IntervalType.Perfect)),
                                    Interval(5, IntervalType(IntervalType.Perfect)),
                                    Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.Dom7Sus: [Interval(1, IntervalType(IntervalType.Perfect)),
                                   Interval(4, IntervalType(IntervalType.Perfect)),
                                   Interval(5, IntervalType(IntervalType.Perfect)),
                                   Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.Dim7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                Interval(3, IntervalType(IntervalType.Minor)),
                                Interval(5, IntervalType(IntervalType.Diminished)),
                                Interval(7, IntervalType(IntervalType.Diminished))],
        TertianChordType.HalfDim7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                    Interval(3, IntervalType(IntervalType.Minor)),
                                    Interval(5, IntervalType(IntervalType.Diminished)),
                                    Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.MinMaj7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                   Interval(3, IntervalType(IntervalType.Minor)),
                                   Interval(5, IntervalType(IntervalType.Perfect)),
                                   Interval(7, IntervalType(IntervalType.Major))],
        TertianChordType.AugMaj7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                   Interval(3, IntervalType(IntervalType.Major)),
                                   Interval(5, IntervalType(IntervalType.Augmented)),
                                   Interval(7, IntervalType(IntervalType.Major))],
        TertianChordType.Aug7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                Interval(3, IntervalType(IntervalType.Major)),
                                Interval(5, IntervalType(IntervalType.Augmented)),
                                Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.DimMaj7: [Interval(1, IntervalType(IntervalType.Perfect)),
                                   Interval(3, IntervalType(IntervalType.Minor)),
                                   Interval(5, IntervalType(IntervalType.Diminished)),
                                   Interval(7, IntervalType(IntervalType.Major))],
        TertianChordType.Dom7Flat5: [Interval(1, IntervalType(IntervalType.Perfect)),
                                     Interval(3, IntervalType(IntervalType.Major)),
                                     Interval(5, IntervalType(IntervalType.Diminished)),
                                     Interval(7, IntervalType(IntervalType.Minor))],
        TertianChordType.Maj6: [Interval(1, IntervalType(IntervalType.Perfect)),
                                Interval(3, IntervalType(IntervalType.Major)),
                                Interval(5, IntervalType(IntervalType.Perfect)),
                                Interval(6, IntervalType(IntervalType.Major))],
        TertianChordType.Min6: [Interval(1, IntervalType(IntervalType.Perfect)),
                                Interval(3, IntervalType(IntervalType.Minor)),
                                Interval(5, IntervalType(IntervalType.Perfect)),
                                Interval(6, IntervalType(IntervalType.Major))],
        TertianChordType.Fr: [Interval(6, IntervalType(IntervalType.Augmented)),
                              Interval(1, IntervalType(IntervalType.Perfect)),
                              Interval(2, IntervalType(IntervalType.Major)),
                              Interval(4, IntervalType(IntervalType.Augmented))],
        TertianChordType.Ger: [Interval(6, IntervalType(IntervalType.Augmented)),
                               Interval(1, IntervalType(IntervalType.Perfect)),
                               Interval(3, IntervalType(IntervalType.Minor)),
                               Interval(4, IntervalType(IntervalType.Augmented))],
        TertianChordType.It: [Interval(6, IntervalType(IntervalType.Augmented)),
                              Interval(1, IntervalType(IntervalType.Perfect)),
                              Interval(4, IntervalType(IntervalType.Augmented))],
        TertianChordType.N6: [Interval(6, IntervalType(IntervalType.Minor)),
    ...
    def parse(chord_string):
        ...
        if inversion_tension:
            ...
            for tension in tensions_parse:   # should only be 1
                ...
                inversion_interval = Interval(int(tension[1]), IntervalType(interval_type))
        ...
        if m.group(TertianChordTemplate.GROUP_TENSIONS):
            ...
            for tension in tensions_parse:
                ...
                interval = Interval(int(tension[3]), IntervalType(interval_type))
